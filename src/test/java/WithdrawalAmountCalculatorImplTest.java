...
public class WithdrawalAmountCalculatorImplTest {
    ...
    @InjectMocks
    private WithdrawalAmountCalculatorImpl calculator;
    ...
    @Test
    public void shouldReturnSum_WhenOnlyWithdrawAllTransactions() {
    ...
    @Test
    public void shouldReturnSumOnlyWithdrawAll_WhenMixedTransactions() {
    ...
    @Test
    public void shouldReturnZero_WhenOnlyDepositTransactions() {
        when(transaction1.isDeposit()).thenReturn(true);
        when(transaction2.isDeposit()).thenReturn(true);
        when(transaction3.isDeposit()).thenReturn(true);
        when(transaction1.sum()).thenReturn(100);
        when(transaction2.sum()).thenReturn(200);
        when(transaction3.sum()).thenReturn(100);
